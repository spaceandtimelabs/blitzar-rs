...
fn main() {
    ...
    /////////////////////////////////////////////
    let weekly_pay_data: Vec<u16> = vec![2000, 7500, 5000, 1500];

    let yearly_bonus_data: Vec<u32> = vec![5000, 0, 400000, 10, 0, 0];
    ...
    let commit_total_compensation =
        (ristretto_sc * commit_weekly_pay + commit_yearly_bonus).compress();
